...
def get_window_index(grid_thw, spatial_merge_size):
        window_index = []
        cu_window_seqlens = [0]
        window_index_id = 0
        # vit_merger_window_size = self.config.window_attn_size // spatial_merge_size // self.config.patch_size
        vit_merger_window_size = 5
        ...
        for grid_t, grid_h, grid_w in grid_thw:
            ...
            cu_seqlens_tmp = seqlens.cumsum(0) * spatial_merge_size * spatial_merge_size + cu_window_seqlens[-1]
...
get_window_index(inputs["image_grid_thw"], spatial_merge_size=2)